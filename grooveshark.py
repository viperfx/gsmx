...
import simplejson
from secrets import *
KEY = API_KEY #fill in with your key
SECRET = API_SECRET #fill in with your secret
...
def authenticate_user(username, password):
    if SESSION_ID == '':
        ...
        response = api_call('authenticate', {'login': username.lower(), 'password': hashlib.md5(password).hexdigest()})
        return response
